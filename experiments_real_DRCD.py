...
def experiment_with_real_data():
	...
	results_df = pd.DataFrame(columns=['Dataset', 'DRCD'])
	...
	results_df.to_csv('./results/real/causality_analysis_results_DRCDonly.csv', index=False)
	
	# Generate and save visualizations
	# generate_bipartite_graph.main('./results/real/causality_analysis_results.csv', './results/real/bipartite_graphs.svg')
	generate_bipartite_graph.main('./results/real/causality_analysis_results_DRCDonly.csv', './results/real/bipartite_graphs_DRCDonly.svg', DRCDonly=True)
